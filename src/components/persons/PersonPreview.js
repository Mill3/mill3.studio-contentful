  ...
  return (
    <Box>
      ...
      <figcaption>
        ...
        <Heading as="h6" fontSize={['4.347826087vw', null, '2.083333333vw', '1.612903226vw']} fontWeight={300} lineHeight={[1.4, null, 1.291666667]} m={0} mt={1} p={0}>{person.title}</Heading>
      </figcaption>
    </Box>
  );
}
