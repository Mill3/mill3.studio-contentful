...
class ContactForm extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid bg={colors.lightGray} pr={`5vw`} _css={{maxWidth: '95vw', marginRight: 0}} {...this.props}>
        <Flex as={FormStyle} ref={this.formRef} flexDirection="column" alignItems="start" pt={6} pb={6} width={`50%`} mx="auto" onSubmit={this.onSubmit}>

          <Flex flexWrap="nowrap" alignItems="center" width={'100%'}>
            <Text as="label" className="h2 is-sans is-light" mb={0} mr={3} htmlFor="type" css={{flex: '0 0 auto'}}>Hey ! Share us your</Text>
            <Select ref={this.typeRef} id="type" name="type" onChange={e => this.setState({ selectedIndex: this.typeRef.current.selectedIndex })}>
