...
const fontSizes = [5, 4, '3.5vw'];
const subtitleFontSizes = [3, 3, '1.8vw'];

const Service = (props) => {
  return (
    <Box width={[1, 1/2, 1/3]} px={[0, 5]} pb={[5, 3]}>
      <Text as="h3" fontSize={3} fontWeight={`normal`} mb={3}>{props.title}</Text>
  ...
  <Layout locale={pageContext.locale}>
    <Container>
      <Box as="header" className="is-center" mb={6}>
        ...
        <Text as="p" fontSize={subtitleFontSizes} width={[1, '60vw']} mb={4} mx="auto">Founded in 2011, our agency is specialized in the analysis, strategy and development of brands and web platforms.</Text>
      ...
      <Box as="section" className={`is-center`} mb={6}>
        ...
        <Text as="p" fontSize={subtitleFontSizes} width={[1, 1/2]} mx="auto" mb={5}>Digital oriented, our services align on</Text>
      ...
      <Box as="section" className={`is-center`} mb={6}>
        ...
        <Text as="p" fontSize={subtitleFontSizes} width={[1, '64vw']} mx="auto" mb={0}>We work for the growth and the influence of brands from here and elsewhere in developing tools and customized campaigns.</Text>
      </Box>
